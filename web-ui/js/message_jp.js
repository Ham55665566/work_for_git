...
arrayMsg[2]  = "PINを入力してください。";
arrayMsg[3]  = "PINが正しくありません(4-8文字)。";
...
arrayMsg[43] = "現在のパスワードが違います。";

arrayMsg[44]  = "PINロック解除コード(PUKコード)を入力してください。";
arrayMsg[45]  = "PINロック解除コード(PUKコード)が正しくありません(8文字)。";
arrayMsg[46]  = "現在のPINを入力してください。";
arrayMsg[47]  = "新しいPINを入力してください。";
arrayMsg[48]  = "PINを再入力してください。";
arrayMsg[49]  = "PINが一致しません。";
...
arrayMsg[57] = "SSIDが正しくありません。(例: MyWIFIAP)\n1-32文字で入力してください。";
...
arrayMsg[104] = "PINが正しくありません。";
arrayMsg[105] = "PINロック解除コード(PUKコード)が正しくありません。";
arrayMsg[106] = "Remaining retry count: ";
arrayMsg[107] = "PINコードの有効/無効を選択してください。";

arrayMsg[108] = "PINロック解除コード(PUK)が正しくありません";
...
arrayMsg[200] = "PINコードの入力を3回失敗しました。PINロック解除コード(PUK)を入力してください。";
arrayMsg[201] = "PINロック解除コード(PUKコード)の入力回数が最大数に達しました。\nお近くのドコモショップまでご来店ください。";
...
arrayMsg[244] = "SIMがロックされています。お近くのドコモショップまでご来店ください。";
arrayMsg[245] = "SIMがロックされています。お近くのソフトバンクショップまでご来店ください。";
arrayMsg[246] = "PUK がロックされました。USIM 交換（有償）が必要です。";
arrayMsg[247] = "PINコードの入力を3回失敗しました。PINロック解除コード(PUK)を入力してください。";